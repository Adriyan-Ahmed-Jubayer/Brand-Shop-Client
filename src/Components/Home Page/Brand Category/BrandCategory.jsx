    ...
    return (
        <>
            <section className="container mx-auto space-y-5 my-12">
                <div>
                    <h1 className="text-center text-xl md:text-3xl lg:text-5xl font-bold">Our Popular <span className="text-purple-500">Brands</span></h1>
                </div>
                <div className="flex items-center justify-center gap-4 md:gap-8 lg:gap-14 lg:justify-between flex-wrap">
                    {
                        Brands.map(brand =>
                            <Link to={`/products/${brand.name}`} key={brand.slug}>
