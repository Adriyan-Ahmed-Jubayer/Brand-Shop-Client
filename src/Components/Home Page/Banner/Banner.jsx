...
const Banner = () => {
    ...
    return (
        <>
            <section className=" relative bg-cover bg-no-repeat w-full container mx-auto text-white flex flex-col justify-center" style={{ backgroundImage: "url('https://i.ibb.co/n3gTYCb/workplace-business-modern-male-accessories-laptop-black-background.jpg')" }} >
                <div className="space-y-1 md:space-y-4 lg:space-y-5 w-4/5 md:w-11/12 lg:w-7/12 text-center mx-auto py-10 md:py-20 lg:py-60">
                    <h1 className=" text-2xl md:text-5xl lg:text-5xl lg:leading-snug ">ElectroBytes: Navigating the Digital World</h1>
