...
const Banner = () => {
    ...
    return (
        <>
            <section className=" relative lg:min-h-screen bg-cover bg-no-repeat w-full container mx-auto text-white flex flex-col justify-center" style={{ backgroundImage: "url('https://i.ibb.co/n3gTYCb/workplace-business-modern-male-accessories-laptop-black-background.jpg')" }} >
                <div className="space-y-1 md:space-y-4 lg:space-y-5 w-4/5 md:w-11/12 lg:w-7/12 text-center mx-auto">
                    ...
                    <form className="space-x-2 md:space-x-3 lg:space-x-4">
                        ...
                        <button className="text-xs md:text-sm lg:text-base bg-[#B68C5A] py-2 px-3 md:py-3 md:px-5 rounded-md  text-white font-semibold cursor-pointer">Search</button>
                    </form>
                </div>
            </section>
        </>
